...
export declare type SingleStrategyCallback = (request: FastifyRequest, reply: FastifyReply, err: null | Error, user?: any, info?: any, status?: number) => Promise<void>;
export declare type MultiStrategyCallback = (request: FastifyRequest, reply: FastifyReply, err: null | Error, user?: any, info?: any, statuses?: (number | undefined)[]) => Promise<void>;
...
export declare class AuthenticationRoute<StrategyNames extends string | string[]> {
    ...
    attemptStrategy(failures: FailureObject[], name: string, request: FastifyRequest, reply: FastifyReply): Promise<unknown>;
